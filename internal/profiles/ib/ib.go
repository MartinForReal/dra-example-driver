...
import (
	...
	configapi "github.com/MartinForReal/dra-infiniband-driver/api/example.com/resource/ib/v1alpha1"
	"github.com/MartinForReal/dra-infiniband-driver/internal/ibverbs"
	"github.com/MartinForReal/dra-infiniband-driver/internal/netns"
	"github.com/MartinForReal/dra-infiniband-driver/internal/profiles"
...
func applyIbConfig(config *configapi.IbConfig, results []*resourceapi.DeviceRequestAllocationResult) (profiles.PerDeviceCDIContainerEdits, error) {
	...
	for i, result := range results {
		...
		hookPath := "/usr/bin/dra-ib-kubeletplugin"
		if len(parts) == 2 {
			ibDevName := parts[0]
